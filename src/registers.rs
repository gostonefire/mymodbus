...
//!
//! Defines the structure for Modbus registers and provides a database of known registers.
...
pub fn register_db() -> &'static HashMap<&'static str, RegisterInfo> {
    REGISTERS.get_or_init(|| {
        ...
        map.insert("meter1_power_R", RegisterInfo { name: "Meter RPower", address: 31026, data_type: "int16", input_type: None, count: None, device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
        map.insert("meter1_power_S", RegisterInfo { name: "Meter SPower", address: 31027, data_type: "int16", input_type: None, count: None, device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
        map.insert("meter1_power_T", RegisterInfo { name: "Meter TPower", address: 31028, data_type: "int16", input_type: None, count: None, device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
        map.insert("grid_power", RegisterInfo { name: "Grid Power", address: 31026, data_type: "sum_i16", input_type: None, count: Some(3), device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
        map.insert("load_power_combined", RegisterInfo { name: "Load Power", address: 31029, data_type: "sum_u16", input_type: None, count: Some(3), device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
        ...
        map.insert("battery_power", RegisterInfo { name: "Battery Power", address: 31036, data_type: "int16", input_type: None, count: None, device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
        ...
        map.insert("battery_soh", RegisterInfo { name: "Battery State of Health", address: 31090, data_type: "uint16", input_type: None, count: None, device_class: Some("battery"), unit_of_measurement: Some("%"), scale: None, precision: None, state_class: Some("measurement") });
        map.insert("load_power", RegisterInfo { name: "Load Power", address: 31127, data_type: "int16", input_type: None, count: None, device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
