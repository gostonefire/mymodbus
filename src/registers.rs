...
pub fn register_db() -> &'static HashMap<&'static str, RegisterInfo> {
    REGISTERS.get_or_init(|| {
        ...
        map.insert("load_power", RegisterInfo { name: "Load Power", address: 31029, data_type: "sum_u16", input_type: None, count: Some(3), device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
        ...
        map.insert("load_power_revised", RegisterInfo { name: "Load Power", address: 31127, data_type: "int16", input_type: None, count: None, device_class: Some("power"), unit_of_measurement: Some("kW"), scale: Some(0.001), precision: Some(3), state_class: Some("measurement") });
